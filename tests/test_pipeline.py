"""
Unit tests for the Life Expectancy Pipeline
Tests all core functionality: validation, transformation, and prediction
"""
...
class TestLifeExpectancyPipeline(unittest.TestCase):
    ...
    def test_predict(self):
        ...
        self.assertEqual(prediction, 75.5)  # From mocked model
...
class TestPipelineIntegration(unittest.TestCase):
    ...
    def test_complete_pipeline_flow(self, mock_dump, mock_read_csv):
        ...
        # Mock the CSV data for preprocessor
        mock_df = pd.DataFrame({
            'country': ['Spain', 'France'],
            'year': [2020, 2020],
            'status': ['Developed', 'Developed'],
